...
HRESULT WINAPI DllGetActivationFactory( HSTRING classid, IActivationFactory **factory )
{
    ...
    *factory = NULL;
    ...
    else if (!wcscmp( buffer, L"Windows.Management.Deployment.StagePackageOptions" ))
        IActivationFactory_QueryInterface( stage_package_options_factory, &IID_IActivationFactory, (void **)factory );
    else if (!wcscmp( buffer, L"Windows.ApplicationModel.LimitedAccessFeatures" ))
        IActivationFactory_QueryInterface( limited_access_features_factory, &IID_IActivationFactory, (void **)factory );
    else if (!wcscmp( buffer, L"Windows.System.Profile.WindowsIntegrityPolicy" ))
